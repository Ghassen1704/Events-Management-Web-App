...
@Service
public class MultiPhotoUpload {

	
	
	
 
	public static String uploadFile(MultipartFile file,String uploadDirectory, String dir,int cnt ) {
		...
		filename = filename.replace(filename, dtf +cnt+"."+ extension);
